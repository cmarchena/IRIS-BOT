...
import os
import re
from filelocations import SCRIPTS as SCRIPTS, BASE_URL
...
def get_links(file_name):
    with open(file_name, "r") as file:
        ...
        text = file.read()
        match = re.search(
            r"https:\/\/choices-live.pixelberrystudios.com\/.*\.protobin", text)
...
def download_new_chapters():
    download_file(BASE_URL + "storefront-2.4.protobin",
                  "storefront-2.4.protobin")
